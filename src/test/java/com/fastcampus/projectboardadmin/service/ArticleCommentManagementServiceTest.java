...
class ArticleCommentManagementServiceTest {
	...
	class RestTemplateTest {
		...
		@Autowired
		RestTemplateTest(ArticleCommentManagementService sut, ProjectProperties projectProperties,
		...
		void givenNothing_whenCallingCommentsApi_thenReturnsCommentList() throws Exception {
			...
			ArticleCommentClientResponse expectedResponse = ArticleCommentClientResponse.of(
